...
-(void) decompressedFrame:(CVImageBufferRef)image frameInfo:(VideoFrameH264Raw *)frame
{
    ...
    if ([self.delegate respondsToSelector:@selector(videoPreviewer:decompressedFrame:fps:)]) {
        [self.delegate videoPreviewer:self decompressedFrame:image fps:frame->frame_info.fps];
    }
