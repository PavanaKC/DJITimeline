...
-(void) videoPreviewer:(VideoPreviewer *)previewer decompressedFrame:(CVImageBufferRef)image fps:(uint16_t)fps;
@end
...
@property (nonatomic, weak) id <VideoPreviewerDelegate>delegate;
